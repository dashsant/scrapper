...
def process(eaps):
    ...
    for item in eaps:
        ...
        for line in f:
            ...
            if True :#not os.path.isfile(outImgPath)  :
                ...
                if not os.path.isfile(outImgPath)  :
                    continue
                if(os.path.getsize(outImgPath) == 0) :
                    continue
                if ret == 0:
...
def main():
    tmp = ['EAP3XXIM.csv' , 'EAP2XXIM.csv',  'EAP6XXIM.csv']
    #tmp = ['EAP2XXIM.csv']
    #tmp = ['EAP6XXIM.csv']
    #tmp = ['EAP341IM.csv']
    #tmp = ['EAP128IM.csv']
    #tmp = ['EAP341I.csv']
    #tmp = ['EAP262I.csv' , 'EAP264I.csv' , 'EAP272I.csv' , 'EAP276I.csv' , 'EAP280I.csv' , 'EAP281I.csv']
    #tmp =  ['EAP211I.csv' , 'EAP212I.csv' ]
    #tmp =  ['EAP205IM.csv']
    #tmp =  ['EAP191I.csv']
    #tmp = ['EAP166I.csv' , 'EAP171I.csv']
    #tmp = ['EAP153I.csv']
    #tmp = ['EAP128I.csv']
    #tmp = ['EAP105IM.csv']
    #tmp=['EAP039I.csv']
